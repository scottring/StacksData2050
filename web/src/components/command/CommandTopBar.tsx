...
export default function CommandTopBar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex h-14 items-center justify-between px-5">
      <div className="flex h-14 w-full items-center justify-between rounded-b-2xl bg-zinc-900/80 backdrop-blur-xl border-b border-white/[0.06] px-5">
        {/* Left: Logo */}
        ...
        <div className="hidden md:flex items-center max-w-md flex-1 mx-8">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full rounded-xl bg-white/[0.06] border border-white/[0.08] py-2 pl-9 pr-4 text-sm text-zinc-300 placeholder:text-zinc-600 focus:outline-none focus:ring-1 focus:ring-emerald-500/30 focus:border-emerald-500/30 transition-colors"
            />
            <kbd className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-zinc-600 font-mono bg-white/[0.06] px-1.5 py-0.5 rounded">
              /
            </kbd>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          {/* Notification bell */}
          <button className="relative flex h-9 w-9 items-center justify-center rounded-xl text-zinc-400 hover:text-zinc-200 hover:bg-white/[0.06] transition-colors">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2.5 rounded-xl px-2.5 py-1.5 hover:bg-white/[0.06] transition-colors">
            ...
            <DropdownMenuContent
              className="w-56 rounded-xl bg-zinc-900 border-white/[0.08] shadow-2xl shadow-black/50"
              align="end"
              sideOffset={8}
            >
              ...
              <DropdownMenuItem asChild className="rounded-lg mx-1 cursor-pointer text-zinc-300 focus:bg-white/[0.06] focus:text-white">
